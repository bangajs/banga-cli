...
class FileManager {
      ...
      * @returns {string} file - just the file name and extention
      * @returns {string} full - full path from working directory. combination of dir and filename
      * @returns {string} fullCwd - full path from root directory.
      * @returns {string} name - Name of the file with no extention or type prefix
      * @returns {string} type - type of file
      * 
      */
